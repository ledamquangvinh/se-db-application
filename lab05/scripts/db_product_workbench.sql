...
INSERT INTO `tb_categories` VALUES (1,'mobile'),(2,'tablet'),(3,'laptop'),(4,'smartwatch');
...
INSERT INTO `tb_products` VALUES (1,'iPhone X',200,1),(2,'iPhone XS MAX',300,1),(3,'iPhone 11 Pro',350,1),(4,'Galaxy S25 Ultra',400,1),(5,'iPhone 13 Pro Max',450,1),(6,'iPhone 14 Pro Max',500,1),(7,'iPhone 15 Pro Max',550,1),(8,'iPad gen 10',400,2),(9,'iPad Air 4',200,2),(10,'iPad Pro M2',500,2),(11,'Galaxy S24',1200,1),(12,'Galazy Z Fold',2500,1),(13,'Galaxy Flip 6',2400,1),(14,'Galaxy Tab S9',2000,2),(15,'Macbook Pro M2',2500,3),(16,'Macbook Pro M3 14 inch',2500,3),(17,'Macbook Pro M3 16 inch',3000,3),(18,'Apple Watch 9',500,4),(19,'Apple Watch Ultra 2',800,4),(20,'Galaxy Watch Ultra',800,4);
...
/*!50003 DROP PROCEDURE IF EXISTS `sp_count_product_by_category` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_count_product_by_category`(
...
-- Dump completed on 2024-08-24 16:21:35
